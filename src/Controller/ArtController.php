...
class ArtController extends AbstractController
{
    ...
    #[Route('/{id_art}', name: 'app_art_show', methods: ['GET'])]
    ...
    #[Route('/{id_art}/edit', name: 'app_art_edit', methods: ['GET', 'POST'])]
    ...
    #[Route('/{id_art}', name: 'app_art_delete', methods: ['POST'])]
    public function delete(Request $request, Art $art, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$art->getIdArt(), $request->request->get('_token'))) {
